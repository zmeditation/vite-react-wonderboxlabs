...
import c from "../src/components/Networking/config.json" assert { type: "json" };
...
//send position every 1/server tick rate seconds
setInterval(sendPositions, 1000 / c.serverTickRate);
